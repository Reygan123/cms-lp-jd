            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.testimony.update', $testimony->id)); ?>" method="POST"
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group mb-4">
                                                <input type="checkbox" name="home" id="home" value="1"
                                                    <?php echo e(old('home', $testimony->home) ? 'checked' : ''); ?>>
                                                ...
                                                <select class="form-control" name="program_id">
                                                    ...
                                                    <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option class="py-1" value="<?php echo e($program->id); ?>"
                                                            <?php if($testimony->program_id == $program->id): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="name"
                                                    value="<?php echo e(old('name', $testimony->name)); ?>" placeholder="Nama Lengkap">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="title"
                                                    value="<?php echo e(old('title', $testimony->title)); ?>" placeholder="Jabatan">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="editor1" name="description" rows="15"><?php echo e(old('description', $testimony->description)); ?></textarea>
                                            ...
                                            <div class="mb-2 mt-4">
                                                <?php if($testimony->image): ?>
                                                    <img src="<?php echo e(asset('storage/testimonies/' . $testimony->image)); ?>"
                                                        alt="<?php echo e($testimony->name); ?>" class="admin-edit-image">
                                                <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mt-4">
                                                <iframe id="ytplayer" type="text/html" width="100%" height="300"
                                                    src="https://www.youtube.com/embed/<?php echo e($testimony->yt_link); ?>" frameborder="0"
                                                    allowfullscreen></iframe>
                                            </div>
                                            <div class="form-group">
                                                <label class="text-label" for="yt_link">ID Video Youtube</label>
                                                <input class="form-control" type="text" name="yt_link"
                                                    value="<?php echo e(old('title', $testimony->yt_link)); ?>"
                                                    placeholder="ID Youtube">
                                                <?php $__errorArgs = ['yt_link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.app', ['title' => 'Testimony'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/cms.jatidiri.app/resources/views/admin/testimony/edit.blade.php ENDPATH**/ ?>