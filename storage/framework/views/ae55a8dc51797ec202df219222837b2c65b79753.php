    ...
    <div class="quixnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-school"></i><span
                ...
                <ul aria-expanded="false">
                    <li><a href="<?php echo e(route('admin.pelatihan.index')); ?>">Daftar Pelatihan</a></li>
                </ul>
            </li>
...
<?php /**PATH C:\Users\Reygan Fadhilah\Downloads\cms-lp-jd-main\cms-lp-jd-main\resources\views/layouts/nav.blade.php ENDPATH**/ ?>