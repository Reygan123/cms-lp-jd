                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="title"
                                        value="<?php echo e(old('title',$post->title),); ?>" placeholder="Judul post">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="editor1" name="description" rows="4"><?php echo e(old('description',$post->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="editor2" name="content" rows="10"><?php echo e(old('content',$post->content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <option class="py-1" value="<?php echo e($category->id); ?>" <?php if($post->category_id == $category->id): ?> selected <?php endif; ?>><?php echo e($category->name); ?></option>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" name="pub_date"
                                                value="<?php echo e(old('pub_date',$post->pub_date)); ?>">
                                        ...
                                        <div class="form-group">
                                            <?php if($post->image && file_exists(public_path('storage/posts/' . $post->image))): ?>
                                                    <img src="<?php echo e(asset('storage/posts/' . $post->image)); ?>"
                                                        alt="<?php echo e($post->title); ?>" class="admin-edit-image">
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', ['title' => 'Blog'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/cms.jatidiri.app/resources/views/admin/post/edit.blade.php ENDPATH**/ ?>